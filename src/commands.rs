...
mod test_orchard_zsa_with_finalization;
...
use crate::commands::test_orchard_zsa_with_finalization::TestOrchardZSAFinalCmd;
...
pub enum AppCmd {
    ...
    TestOrchardZSAFinal(TestOrchardZSAFinalCmd),
    Clean(CleanCmd),
}
